...
base_directory = "/home/barykin/bz/release/forks/ENLocalize/translations/backend"
target_directory = "/home/barykin/bz/release/Localizer/src/Cognitive.Localizer/wwwroot/backend"
log_file_path = "compare_and_update_jsons.txt"
json_file_pattern = "*.json"  # Маска для имен файлов
